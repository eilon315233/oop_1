...
public class GameLogic implements PlayableLogic{
    ...
    public void undoLastMove() {
        ...
        //Fix kills only if you are pawn
       if(movedPiece instanceof Pawn)
        ...
        {
            movedPiece.addDistance(Math.abs(to.getX()- from.getX())*(-1));
            System.out.println("Distace: "+Math.abs(to.getX()- from.getX())*(-1));
        }
        else
        {
            movedPiece.addDistance(Math.abs(to.getY()- from.getY())*(-1));
            System.out.println("Distace: "+Math.abs(to.getY()- from.getY())*(-1));
        }
        System.out.println("Last Point: ("+movedPiece.getLastPos().getX()+", "+movedPiece.getLastPos().getY()+")");
